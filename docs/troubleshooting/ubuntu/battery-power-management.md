# Troubleshooting Battery Power Management on Ubuntu

This guide provides tools and techniques to improve battery life and troubleshoot power management issues on Ubuntu laptops.
...
Modern Ubuntu (with the GNOME desktop) includes simple power profiles that are a good first step.
...
By combining the built-in power profiles with a tool like TLP, you can significantly extend your laptop's battery life on Ubuntu.
